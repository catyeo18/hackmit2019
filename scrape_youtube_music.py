...
def return_track(emotion):
	...
	if emotion == 'HAPPY' or emotion == 'POSITIVE':
		...
		URL = "https://www.youtube.com/playlist?list=RDCLAK5uy_me-_8E3GmF51_h9dejQLpsYdclYDEQsJo"
	elif emotion == 'ANGRY':
		URL = "https://www.youtube.com/playlist?list=RDCLAK5uy_mPqT1su7A0jeg2kTWdhj7I6JyDfwD4O-4"
	else:
		URL = "https://www.youtube.com/playlist?list=RDCLAK5uy_nC_-FNtuwJ5j7bav_KQPsFLaataIQdNjE"
